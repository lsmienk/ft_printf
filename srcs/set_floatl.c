...
/*                                                   +#+                      */
/*   Created: 2019/12/02 15:51:35 by lsmienk        #+#    #+#                */
/*   Updated: 2019/12/11 13:54:23 by lsmienk       ########   odam.nl         */
/*                                                                            */
/* ************************************************************************** */

#include "../ft_printf.h"

static void			last_number(t_param *param, long double f,
...
static void			print_float(t_param *param, long double f,
							unsigned long long in)
{
	if (param->prec == 0)
	{
...
static void			set_it(t_param *param, long double f,
							unsigned long long in, int sign)
{
	int				w;
	int				x;
